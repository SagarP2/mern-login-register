...
export const sendRegisterOTP =
  (email, setErrorObj, setPage) => async (dispatch) => {
    try {
      ...
      setErrorObj({
        ...initialErrorObj,
        sendRegisterOTP: error.response.data.message,
      });
      console.log(
        "error in sendRegisterOTP - user.js actions",
...
export const register =
  (userData, navigate, setErrorObj, setUserFormData) => async (dispatch) => {
    try {
      dispatch({ type: START_LOADING });
      ...
      console.log(
        "error in register - user.js actions",
        error.response.data.message
      );
      dispatch({ type: END_LOADING });
    }
...
export const login =
  (userData, navigate, setErrorObj, setUserFormData) => async (dispatch) => {
    try {
      ...
      console.log(
        "error in login - user.js actions",
        error.response.data.message
      );
      dispatch({ type: END_LOADING });
    }
...
export const sendForgetPasswordOTP =
  (email, setPage, setErrorObj) => async (dispatch) => {
    try {
      dispatch({ type: START_LOADING });
      ...
      if (data.success) {
        ...
        setErrorObj({
          ...initialErrorObj,
          sendForgetPasswordOTP: data.message,
        });
      }
      ...
      setErrorObj({
        ...initialErrorObj,
        sendForgetPasswordOTP: error.response.data.message,
      });
      console.log(
        "error in sendForgetPasswordOTP - user.js actions",
        error.response.data.message
      );
      dispatch({ type: END_LOADING });
    }
...
export const changePassword =
  (userData, setPage, setErrorObj, setUserFormData) => async (dispatch) => {
    try {
      dispatch({ type: START_LOADING });
      ...
      console.log(
        "error in changePassword - user.js actions",
        error.response.data.message
      );
      dispatch({ type: END_LOADING });
    }
...
export const logout = () => async (dispatch) => {
  try {
    ...
    console.log(
      "error in logout - user.js actions",
      error.response.data.message
    );
    dispatch({ type: END_LOADING });
  }
